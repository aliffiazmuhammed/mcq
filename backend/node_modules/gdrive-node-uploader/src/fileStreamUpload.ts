...
import { UploadFileStreamParams, UploadFileStreamResult } from './types';
...
export const fileStreamUpload = async ({ buffer, fileName, parentFolderId, auth }: UploadFileStreamParams): Promise<UploadFileStreamResult> => {
